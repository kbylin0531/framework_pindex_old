        ...
        var i = 'input[type!="hidden"]', n = {
            init: function () {
                return this.each(function () {
                    var t, n, a, s, o, r, l = e(this), c = l.closest("form"), u = "", d = l.attr("class"), h = "ON", p = "OFF", f = !1, m = !1;
                    ...
                    l.on("keydown", function (t) {
                        ...
                        var n = e(this), a = n.parent(), s = n.is(":checked"), o = a.is(".switch-off");
                        if (t.preventDefault(), a.css("left", ""), o === s) {
                            ...
                            a.parent().trigger("switch-change", {el: n, value: s})
                        }
                        ...
                        r = !1, t.preventDefault(), t.stopImmediatePropagation(), i.closest("div").removeClass("switch-animate"), i.closest(".has-switch").is(".deactivate") ? i.unbind("click") : i.closest(".switch-on").parent().is(".radio-no-uncheck") ? i.unbind("click") : (i.on("mousemove touchmove", function (t) {
                            var i = e(this).closest(".make-switch"), n = (t.pageX || t.originalEvent.targetTouches[0].pageX) - i.offset().left, a = 100 * (n / i.width()), s = 25, o = 75;
                            r = !0, s > a ? a = s : a > o && (a = o), i.find(">div").css("left", a - o + "%")
                        }), i.on("click touchend", function (t) {
                            var i = e(this), n = i.siblings("input");
                ...
                var i = e(this).find(".switch-left"), n = "";
                ...
                var i = e(this).find(".switch-right"), n = "";
                ...
                var i = e(this), n = i.find(".switch-left"), a = i.find(".switch-right"), s = i.find("label");
                ...
                var t, i = e(this), n = i.find("div"), a = i.closest("form");
